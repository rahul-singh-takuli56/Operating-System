...
int find_MRU(int *pageString, int i, int no_of_pages, int no_of_frames, int
*frames)
{
 int *flag;
...
pageString[i], idx + 1);
 ...
 {
 index = find_MRU(pageString, i, no_of_pages, no_of_frames,
frames);
 printf("Page Miss : Replacing %d Frame Page with %d Page
